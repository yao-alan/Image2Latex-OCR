...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--model',
        help="Path for model parameters; ../saved/run4/CRNN_params_epoch_5.pt if not given.",
        type=str
    )
    ...
    model_path = args.model if args.model else '../saved/run4/CRNN_params_epoch_5.pt'
